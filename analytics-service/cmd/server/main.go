...
import (
	...
	"github.com/darkphotonKN/community-builds-microservice/analytics-service/config"
	"github.com/darkphotonKN/community-builds-microservice/analytics-service/internal/analytics"
...
var (
	...
	grpcAddr    = commonhelpers.GetEnvString("PORT", "7008")
...
func main() {
	...
	service := analytics.NewService(repo, ch)
	consumer := analytics.NewConsumer(service, ch)
	consumer.Listen()

	log.Printf("grpc Analytics Server started on PORT: %s\n", grpcAddr)
