...
type Notification struct {
	...
	// bool read = 6 [(google.api.field_behavior) = OUTPUT_ONLY];
	EmailSent     bool   `protobuf:"varint,7,opt,name=emailSent,proto3" json:"emailSent,omitempty"`
	SourceId      string `protobuf:"bytes,8,opt,name=sourceId,proto3" json:"sourceId,omitempty"` // google.protobuf.Timestamp created_at = 9;
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_proto_notification_notification_proto_rawDesc = "" +
	"\n" +
	")api/proto/notification/notification.proto\x12\fnotification\"J\n" +
	...
	"\bsourceId\x18\b \x01(\tR\bsourceId\"\x82\x01\n" +
...
var file_api_proto_notification_notification_proto_depIdxs = []int32{
	...
	3, // 1: notification.NotificationService.GetNotifications:input_type -> notification.GetNotificationsRequest
	4, // 2: notification.NotificationService.ReadNotification:input_type -> notification.ReadNotificationRequest
