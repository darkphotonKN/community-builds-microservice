...
func (c *itemServiceClient) GenerateUniqueItems(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GenerateUniqueItemsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateUniqueItemsResponse)
	err := c.cc.Invoke(ctx, ItemService_GenerateUniqueItems_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ItemService_GenerateUniqueItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ItemServiceServer).GenerateUniqueItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ItemService_GenerateUniqueItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ItemServiceServer).GenerateUniqueItems(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ItemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "itemgrpc.ItemService",
	...
	Metadata: "api/proto/item/item.proto",
}
